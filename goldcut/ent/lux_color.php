...
class Lux_Color
{
    ...
    {
        return self::rgb2hsl(self::hsv2rgb($hsv));
    }
     ...
     *
     */
    protected static function _hue2rgb($v1, $v2, $vH)
    {
        if ($vH < 0) {
            $vH += 1;
        }
     ...
     *
     */
    public static function hsl2hsv($hsl)
    {
        return self::rgb2hsv(self::hsl2rgb($hsl));
    }
     ...
     *
     */
    public static function updateHsv($hsv, $values)
    {
        if (isset($values[0])) {
     ...
     *
     */
    public static function updateHsl($hsl, $values)
    {
        if (isset($values[0])) {
