            ...
            <form style="margin-top: 10px" class='commentForm bonus contact-form' method="POST" action="/bonus/handle">
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Имя</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Дата свадьбы</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Цвет платья</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Силует платья</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Декор платья</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Размер</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Фата</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Готовое платье или пошив</div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <div class="error left-align">Ваш телефон</div>
                    </div>
                </div>
